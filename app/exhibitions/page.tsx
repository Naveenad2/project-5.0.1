...
const TEXT_EN = {
    ...
    langToggle: "عربي",
    title: "EXHIBITIONS",
    subtitle: "Agency Division // Stand Build",
    fabricationHq: "Fabrication HQ",
    heroDesc: "Operating a fully integrated 68-person production facility in Bahrain. We turn complex architectural blueprints into striking physical realities.",
    philosophy: "Philosophy",
    overview: "We architect immersive brand environments. With 17 years of operation in the Kingdom of Bahrain, our fabrication division merges structural engineering with striking visual design to dominate any exhibition floor.",
    
    stat1Label: "Legacy Established", stat1Value: "17 Yrs",
    stat2Label: "In-House Production", stat2Value: "68 Staff",
    stat3Label: "Client Satisfaction", stat3Value: "100%",
    
    coreCompetencies: "Core Competencies",
    structEng: "Structural Engineering",
    structEngDesc: "From custom carpentry to precision metal fabrication.",
    
    cap1Title: "Custom Fabrication", cap1Desc: "Bespoke stand design and premium in-house manufacturing, utilizing our dedicated carpentry, painting, and metal fabrication teams.",
    cap2Title: "Country Pavilions", cap2Desc: "Large-scale national representations and massive structural builds for global expos and summits.",
    cap3Title: "Interactive Tech", cap3Desc: "Seamlessly integrated LED screens, AV solutions, and interactive displays built directly into the architecture.",
    cap4Title: "Modular Systems", cap4Desc: "Scalable, reusable, and structurally sound architectures engineered for multi-city regional tours.",

    methodology: "Methodology",
    builtPrecision: "Built with Precision.",
    methodDesc: "An end-to-end industrial approach. From CAD blueprints to final structural assembly, our process guarantees absolute stability and aesthetic perfection.",
    
    step1Vol: "Step 01", step1Title: "3D Spatial Design", step1Desc: "Architectural rendering, structural CAD modeling, and precise material specification aligned with brand guidelines.",
    step2Vol: "Step 02", step2Title: "In-House Manufacturing", step2Desc: "Complete in-house production including CNC machining, custom carpentry, metal fabrication, and precise paint finishing.",
    step3Vol: "Step 03", step3Title: "Logistics & Install", step3Desc: "Comprehensive on-site assembly, electrical rigging, structural safety checks, and seamless post-event dismantling.",

    archiveTitle: "Curated Archive",
    selectDeps: "Select Builds // GCC Region",
    caseStudy: "Fabrication Case Study",
    archiveIndex: "Archive 0",

    ctaTitle: "Ready to build your presence?",
...
const TEXT_AR = {
    ...
    langToggle: "EN",
    title: "المعارض",
    subtitle: "قسم الوكالة // بناء الأجنحة",
    fabricationHq: "مركز التصنيع",
    heroDesc: "ندير منشأة إنتاج متكاملة تضم 68 خبيراً في البحرين. نحن نحول المخططات المعمارية المعقدة إلى حقائق مادية مذهلة.",
    philosophy: "فلسفتنا",
    overview: "نحن نصمم بيئات غامرة للعلامات التجارية. مع 17 عاماً من العمل في مملكة البحرين، يدمج قسم التصنيع لدينا الهندسة الهيكلية مع التصميم المرئي المذهل للسيطرة على أي مساحة عرض.",
    
    stat1Label: "تأسيس الإرث", stat1Value: "17 عاماً",
    stat2Label: "الإنتاج الداخلي", stat2Value: "68 موظف",
    stat3Label: "رضا العملاء", stat3Value: "100%",
    
    coreCompetencies: "الكفاءات الأساسية",
    structEng: "الهندسة الهيكلية",
    structEngDesc: "من النجارة المخصصة إلى تصنيع المعادن بدقة.",
    
    cap1Title: "تصنيع مخصص", cap1Desc: "تصميم أجنحة مخصص وتصنيع داخلي متميز، باستخدام فرق النجارة والطلاء وتصنيع المعادن المتخصصة لدينا.",
    cap2Title: "الأجنحة الوطنية", cap2Desc: "تمثيلات وطنية واسعة النطاق وهياكل ضخمة للمعارض والقمم العالمية.",
    cap3Title: "تكنولوجيا تفاعلية", cap3Desc: "شاشات LED مدمجة بسلاسة، حلول صوت وصورة، وشاشات تفاعلية مدمجة مباشرة في التصميم.",
    cap4Title: "أنظمة معيارية", cap4Desc: "هياكل قابلة للتطوير وإعادة الاستخدام وقوية هندسياً مصممة للجولات الإقليمية متعددة المدن.",

    methodology: "المنهجية",
    builtPrecision: "مبنية بدقة.",
    methodDesc: "نهج صناعي متكامل. من مخططات CAD إلى التجميع الهيكلي النهائي، تضمن عمليتنا استقراراً مطلقاً وكمالاً جمالياً.",
    
    step1Vol: "خطوة 01", step1Title: "تصميم مكاني ثلاثي الأبعاد", step1Desc: "تصميم معماري، ونمذجة هيكلية CAD، ومواصفات مواد دقيقة تتماشى مع إرشادات العلامة التجارية.",
    step2Vol: "خطوة 02", step2Title: "التصنيع الداخلي", step2Desc: "إنتاج داخلي كامل يشمل آلات CNC، والنجارة المخصصة، وتصنيع المعادن، والتشطيب الدقيق للطلاء.",
    step3Vol: "خطوة 03", step3Title: "الخدمات اللوجستية والتركيب", step3Desc: "تجميع شامل في الموقع، وتجهيزات كهربائية، وفحوصات سلامة هيكلية، وتفكيك سلس بعد الحدث.",

    archiveTitle: "أرشيف منسق",
    selectDeps: "بناء مختار // منطقة الخليج",
    caseStudy: "دراسة حالة تصنيع",
    archiveIndex: "أرشيف 0",

    ctaTitle: "هل أنت مستعد لبناء حضورك؟",
...
export default function ExhibitionsPage() {
    ...
    return (
        ...
        <main ref={containerRef} className={`bg-[#050505] h-screen w-full text-white font-sans selection:bg-violet-500/30 overflow-y-auto overflow-x-hidden relative scroll-smooth custom-scrollbar ${isAr ? 'dir-rtl' : 'dir-ltr'}`} dir={isAr ? "rtl" : "ltr"}>
            ...
            <nav className="fixed top-0 left-0 w-full z-50 px-6 py-6 md:px-10 md:py-8 flex justify-between items-start pointer-events-none mix-blend-difference">
                ...
                <div className="pointer-events-auto flex items-center gap-4 md:gap-6">
                    ...
                    >
                        <Globe size={16} className="group-hover:text-violet-400 transition-colors" />
            ...
            <section className="relative h-[85svh] md:h-[100svh] w-full overflow-hidden flex items-end pb-12 md:pb-24 px-6 md:px-12 lg:px-24 shrink-0">
                ...
                <div className="relative z-10 w-full max-w-[1800px] mx-auto flex flex-col items-start">
                    ...
                    >
                        ...
                        <h1 className="text-[10vw] md:text-[9vw] lg:text-[9rem] font-black uppercase tracking-tighter leading-[0.8] text-white mix-blend-plus-lighter drop-shadow-2xl">
                            {t.title}
                        </h1>
