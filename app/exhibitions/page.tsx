...
// --- PAGE DATA: EXHIBITIONS ---
const PAGE_DATA = {
    title: "EXHIBITIONS",
    subtitle: "STAND BUILD",
    themeColor: "#8B5CF6", // Electric Violet
    heroImage: "/insta/image2.png", // Main hero image
    ...
    stats: [
        { label: "Legacy Established", value: "17 Yrs" },
        { label: "In-House Production", value: "68 Staff" },
        { label: "Client Satisfaction", value: "100%" }
    ],
    capabilities: [
        { 
            title: "Custom Fabrication", 
            desc: "Bespoke stand design and premium in-house manufacturing, utilizing our dedicated carpentry, painting, and metal fabrication teams.", 
            image: "/insta/image6.png" 
        },
        { 
            title: "Country Pavilions", 
            desc: "Large-scale national representations and massive structural builds for global expos and summits.", 
            image: "/insta/image7.png" 
        },
        { 
            title: "Interactive Tech", 
            desc: "Seamlessly integrated LED screens, AV solutions, and interactive displays built directly into the architecture.", 
            image: "/insta/image8.png" 
        },
        { 
            title: "Modular Systems", 
            desc: "Scalable, reusable, and structurally sound architectures engineered for multi-city regional tours.", 
            image: "/insta/image9.png" 
        }
    ],
    process: [
        { step: "Vol. 01", title: "3D Spatial Design", desc: "Architectural rendering, structural CAD modeling, and precise material specification aligned with brand guidelines." },
        { step: "Vol. 02", title: "In-House Manufacturing", desc: "Complete in-house production including CNC machining, custom carpentry, metal fabrication, and precise paint finishing." },
        { step: "Vol. 03", title: "Logistics & Install", desc: "Comprehensive on-site assembly, electrical rigging, structural safety checks, and seamless post-event dismantling." }
    ],
    images: [
...
export default function ExhibitionsPage() {
    // --- BUG FIX: Added timelineRef here ---
    ...
    return (
        <main ref={containerRef} className="bg-[#050505] h-screen w-full text-white font-sans selection:bg-violet-500/30 overflow-y-auto overflow-x-hidden relative scroll-smooth custom-scrollbar">
                        ...
                        >
                            <div className="flex justify-between items-center border-b border-white/10 pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-white">Fabrication HQ</span>
                                </div>
                                <Globe size={16} className="text-white/50" />
                            </div>
                            
                            <p className="text-[11px] text-white/80 leading-relaxed font-light">
                                Operating a fully integrated 68-person production facility in Bahrain. We turn complex architectural blueprints into striking physical realities.
                            </p>
                ...
                <div className="max-w-[1800px] mx-auto">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="flex flex-col md:flex-row md:items-end justify-between border-b border-white/10 pb-12 mb-12 md:mb-16 gap-6">
                        <div>
                            ...
                            <h2 className="text-4xl md:text-6xl font-medium tracking-tighter text-white drop-shadow-md">Structural Engineering</h2>
                        </div>
                        <p className="text-xs font-mono text-white/50 uppercase tracking-widest max-w-xs md:text-right">
                            From custom carpentry to precision metal fabrication.
                        </p>
                    </motion.div>
                ...
                <div className="max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
                    ...
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="lg:col-span-5 sticky top-32 self-start">
                        ...
                        <h2 className="text-4xl md:text-6xl lg:text-7xl font-medium tracking-tighter text-white leading-[0.9] mb-6 drop-shadow-lg">
                            Built with <br/> Precision.
                        </h2>
                        <p className="text-white/70 font-light text-lg">
                            An end-to-end industrial approach. From CAD blueprints to final structural assembly, our process guarantees absolute stability and aesthetic perfection.
                        </p>
                    </motion.div>
            ...
            <section className="py-24 md:py-40 px-4 md:px-12 lg:px-24 shrink-0">
                <div className="max-w-[1800px] mx-auto">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="flex flex-col items-center text-center mb-16 md:mb-24">
                        ...
                        <span className="text-[10px] font-mono text-white/50 mt-6 tracking-[0.3em] uppercase">Select Builds // GCC Region</span>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 auto-rows-[250px] md:auto-rows-[350px] gap-3 md:gap-5">
                        {PAGE_DATA.images.map((src, i) => {
                            ...
                            return (
                                ...
                                >
                                    <Image 
                                        src={src} alt={`Exhibition ${i+1}`} fill sizes="(max-width: 768px) 100vw, 50vw"
                                    ...
                                    <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8">
                                        <div className="translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out flex items-end justify-between">
                                            <div className="flex flex-col gap-1">
                                                <span className="text-[9px] font-bold uppercase tracking-widest text-white">Fabrication Case Study</span>
