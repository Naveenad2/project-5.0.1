...
const TEXT_AR = {
    ...
    fabricationHq: "معايير عالمية. مصممة في البحرين والسعودية.",
    ...
    philText: "في عالم مشبع بالرسائل، أصبح الحضور الهادف ميزة تنافسية. نصمم بيئات معارض تفعل أكثر من جذب الانتباه — فهي تخلق الحوار، وتشكّل الإدراك، وتعزز هوية العلامة التجارية. بالجمع بين الرؤية الإبداعية والخبرة التقنية وقدرات الإنتاج الصناعي، نحوّل مساحات المعارض إلى منصات قوية لسرد القصص ونمو المشاريع.",
    ...
    cap1Title: "أجنحة معارض مخصصة", cap1Desc: "مساحات معارض مصممة خصيصًا ومصنّعة بخبرة لتعكس هوية علامتك التجارية، وتشرك الجماهير، وتحسن أداء المعرض.",
    ...
    methodDesc: "بيئات المعارض الاستثنائية لا تُجمَّع — بل تصمم من الصفر. يتبع كل مشروع عملية منظمة تدمج التصميم الإبداعي والتخطيط التقني والتميز في التصنيع والنشر الخالي من العيوب.",
    ...
    step2Vol: "02", step2Title: "التصنيع والإنتاج المتقدم", step2Desc: "يُنتَج كل مكوّن بالكامل من خلال قدراتنا، ويُصاغ باهتمام دقيق بالتفاصيل. من النجارة المخصصة وتصنيع المعادن إلى إنتاج CNC والتشطيب المتخصص، يُصنَّع كل عنصر وفق أعلى المعايير.",
    ...
    ctaDesc: "سواء كنت تعرض محليًا، أو تطلق دوليًا، أو تمثل دولة على المسرح العالمي، فإن فريقنا مستعد لتحويل رؤيتك إلى واقع. لنصنع حضورًا يأسر الانتباه ويترك انطباعًا دائمًا.",
