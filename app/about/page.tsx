...
const TEXT_AR = {
    ...
    build: "بناء.",
    deliver: "ارتقاء.",
    desc: "نبتكر بيئات غامرة، وتجارب علامات تجارية فارقة، وفعاليات عالمية المستوى تدفع الأفراد والشركات نحو الأمام. من مقرها في البحرين، ومن خلال رؤية عالمية، تقدم كلرز البحرين حلولاً متكاملة للفعاليات والمعارض والمساحات في جميع أنحاء دول مجلس التعاون الخليجي وخارجها.",
    scroll: "قم بالتمرير للاستكشاف",

    cap1: "فعاليات وتجارب", cap1Desc: "من تطوير الفكرة إلى التنفيذ المباشر، نحوّل الأفكار إلى بيئات لا تُنسى مصممة لإلهام التفاعل والتواصل الإنساني.",
    ...
    missionTitle: "مهمتنا",
    missionText: "صياغة تجارب استثنائية تثري التواصل، وتعزز مكانة العلامات التجارية، وتصنع تأثيرًا هادفًا. من خلال الابتكار والتفكير الاستراتيجي والاهتمام الذي لا يقبل المساومة بالتفاصيل، نقدم حلولاً متكاملة للفعاليات والمعارض تتجاوز التوقعات وتحوّل الرؤى إلى واقع.",
    visionTitle: "رؤيتنا",
    visionText: "إعادة تعريف مستقبل التصميم التجريبي وإدارة الفعاليات من خلال الإبداع والابتكار والتنفيذ عالمي المستوى. نتصور عالمًا تصبح فيه كل بيئة نبتكرها حافزًا للحوار والتفاعل والتجارب الإنسانية المؤثرة — حيث نعيد تشكيل الصناعات والمجتمعات والعلامات التجارية العالمية على حد سواء.",
    ...
    goal4: "التفكير المستدام", goal4Desc: "دمج الممارسات الواعية بيئيًا في إقامة الفعاليات والمعارض الحديثة.",
    ...
    step2: "التصنيع والإنتاج المخصص", step2Desc: "تصنيع دقيق وإنتاج قائم على التفاصيل يُنفَّذ عبر منشأتنا المتطورة في البحرين.",
    ...
    portfolioDesc: "عرض منسق لبيئات غامرة، وتصميم معارض، وفعاليات تجريبية تم تصميمها وتنفيذها عبر مختلف القطاعات والأسواق الدولية.",
    index: "فهرس",
    ...
    saudiAddress: "مبنى: 7073، شارع: عباد بن عبار، الصناعية الفوازية، الخبر، المملكة العربية السعودية",
    ...
    dossier: "أرسل ملفك. سيقوم فريق التخطيط الاستيراتيجي لدينا بالاستلام.",
    identity: "الهوية",
