...
const PAGE_DATA = {
    ...
    heroImage: "/insta/image3.png", // Main hero image
    ...
    stats: [
        { label: "Premium Fit-Outs", value: "200+" },
    ...
    capabilities: [
        { 
            ...
            desc: "High-end retail environments designed to maximize footfall and elevate physical brand perception.", 
            image: "/insta/image6.png" 
        },
        { 
            icon: Coffee,
            title: "F&B Venues", 
            desc: "Atmospheric restaurants, lounges, and cafes engineered for seamless operational flow and aesthetic impact.", 
            image: "/insta/image7.png" 
        },
        { 
            icon: Briefcase,
            title: "Corporate Workspaces", 
            desc: "Ergonomic, modern office environments that foster productivity and reflect your corporate identity.", 
            image: "/insta/image8.png" 
        },
        { 
            icon: Sofa,
            title: "Commercial Spaces", 
            desc: "Permanent and semi-permanent structures built for high visibility and long-term durability in major malls.", 
            image: "/insta/image9.png" 
        }
    ],
    process: [
        { step: "Vol. 01", title: "Spatial Planning", desc: "Comprehensive floor planning, MEP (Mechanical, Electrical, Plumbing) engineering integration, and 3D conceptual rendering." },
        { step: "Vol. 02", title: "Material & Fabrication", desc: "Procurement of premium finishes alongside in-house bespoke joinery, carpentry, and metalwork in our Bahrain facility." },
        { step: "Vol. 03", title: "Turnkey Execution", desc: "Rigorous on-site construction, strict quality control, and final handover ready for immediate commercial operation." }
    ],
    images: [
...
export default function InteriorsPage() {
    ...
    return (
        <main ref={containerRef} className="bg-[#050505] h-screen w-full text-white font-sans selection:bg-blue-500/30 overflow-y-auto overflow-x-hidden relative scroll-smooth custom-scrollbar">
                        ...
                        >
                            <div className="flex justify-between items-center border-b border-white/10 pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-white">Spatial Engineering</span>
                                </div>
                                <Globe size={16} className="text-white/50" />
                            </div>
                            
                            <p className="text-[11px] text-white/80 leading-relaxed font-light">
                                Executing high-end commercial fit-outs across the GCC. We bridge the gap between architectural ambition and flawless physical execution.
                            </p>
                ...
                <div className="max-w-[1800px] mx-auto">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="flex flex-col md:flex-row md:items-end justify-between border-b border-white/10 pb-12 mb-12 md:mb-16 gap-6">
                        <div>
                            ...
                            <h2 className="text-4xl md:text-6xl font-medium tracking-tighter text-white drop-shadow-md">Spatial Architecture</h2>
                        </div>
                        <p className="text-xs font-mono text-white/50 uppercase tracking-widest max-w-xs md:text-right">
                            From custom joinery to comprehensive MEP integration.
                        </p>
                    </motion.div>
                ...
                <div className="max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
                    ...
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="lg:col-span-5 sticky top-32 self-start">
                        ...
                        <p className="text-white/70 font-light text-lg">
                            A fully integrated approach. From spatial planning to final handover, our in-house capabilities guarantee absolute precision and timely delivery.
                        </p>
                    </motion.div>
            ...
            <section className="py-24 md:py-40 px-4 md:px-12 lg:px-24 shrink-0">
                <div className="max-w-[1800px] mx-auto">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="flex flex-col items-center text-center mb-16 md:mb-24">
                        ...
                        <h2 className="text-4xl md:text-7xl font-medium tracking-tighter text-white drop-shadow-md">Curated Spaces</h2>
                        <span className="text-[10px] font-mono text-white/50 mt-6 tracking-[0.3em] uppercase">Select Fit-Outs // Commercial</span>
                    </motion.div>
                                    ...
                                    <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8">
                                        <div className="translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out flex items-end justify-between">
                                            <div className="flex flex-col gap-1">
                                                <span className="text-[9px] font-bold uppercase tracking-widest text-white">Interior Case Study</span>
