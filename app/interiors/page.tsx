...
const TEXT_AR = {
    ...
    heroDesc: "في كلرز، التصميم الداخلي أكثر من مجرد بيئات — إنها أصول استراتيجية مصممة للتأثير على كيفية عمل الناس وتفاعلهم وانخراطهم وتجربتهم للعلامة التجارية.",
    philosophy: "فلسفتنا",
    overview: "نقدم حلول تجهيز وتصميم داخلي تجاري راقية في جميع أنحاء دول الخليج والأسواق الدولية، محوّلين الرؤية المعمارية إلى تنفيذ دقيق. كل مساحة نبتكرها توازن بين الجماليات والوظيفة والغاية، لتضمن وجود الشكل والأداء في تناغم تام.",
    ...
    builtToLast: "مصممة، لا مُزخرَفة.",
    methodDesc: "التصميمات الداخلية الاستثنائية لا تُزخرَف. بل تصمم بحرفية. يتبع كل مشروع منهجية منضبطة تدمج التفكير الإبداعي والخبرة التقنية والتميز الإنشائي لضمان تسليم سلس من الفكرة إلى الاكتمال.",
    ...
    archiveDesc: "يمثل كل مشروع التقاءً فريدًا للتصميم والهندسة والحرفية والتفكير الاستراتيجي — لخلق بيئات تحقق أهدافها بنفس جمال مظهرها.",
