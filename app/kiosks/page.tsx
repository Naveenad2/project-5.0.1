...
// --- PAGE DATA: MALL KIOSKS ---
const PAGE_DATA = {
    title: "MALL KIOSKS",
    subtitle: "RETAIL POP-UPS",
    themeColor: "#10B981", // Neon Emerald
    heroImage: "/insta/image4.png", // Main hero image
    ...
    stats: [
        { label: "Retail Activations", value: "300+" },
        { label: "Footfall Engagement", value: "Maximum" },
    ...
    capabilities: [
        { 
            icon: ShoppingBag,
            title: "Brand Pop-Ups", 
            desc: "Immersive temporary retail spaces designed to launch products and drive immediate consumer action.", 
            image: "/insta/image5.png" 
        },
        { 
            icon: MapPin,
            title: "Permanent Kiosks", 
            desc: "Durable, 360-degree retail structures engineered for high-traffic mall corridors and long-term use.", 
            image: "/insta/image6.png" 
        },
        { 
            icon: Sparkles,
            title: "Experiential Zones", 
            desc: "Interactive activation areas featuring digital touchpoints, gamification, and photo-ready aesthetics.", 
            image: "/insta/image7.png" 
        },
        { 
            icon: Coffee,
            title: "F&B Outlets", 
            desc: "Compact, fully-functional food and beverage kiosks fully compliant with strict mall safety and health regulations.", 
            image: "/insta/image8.png" 
        }
    ],
    process: [
        { step: "Vol. 01", title: "Traffic & Flow Analysis", desc: "Evaluating mall guidelines, footfall patterns, and spatial dimensions to maximize visibility and accessibility." },
        { step: "Vol. 02", title: "Design & Fabrication", desc: "Creating detailed 3D renders and manufacturing premium, durable components in our Bahrain production facility." },
        { step: "Vol. 03", title: "Overnight Installation", desc: "Executing rapid, stealthy installations and technical rigging outside of mall operating hours for zero disruption." }
    ],
    images: [
        "/insta/image4.png", "/insta/image5.png", "/insta/image6.png", 
        "/insta/image7.png", "/insta/image8.png", "/insta/image1.png", "/insta/image2.png"
    ]
};
...
export default function KiosksPage() {
    ...
    return (
        <main ref={containerRef} className="bg-[#050505] h-screen w-full text-white font-sans selection:bg-emerald-500/30 overflow-y-auto overflow-x-hidden relative scroll-smooth custom-scrollbar">
            ...
            <section className="relative h-[85svh] md:h-[100svh] w-full overflow-hidden flex items-end pb-12 md:pb-24 px-6 md:px-12 lg:px-24 shrink-0">
                ...
                <div className="relative z-10 w-full max-w-[1800px] mx-auto flex flex-col items-start">
                    ...
                    >
                        ...
                        <h1 className="text-[12vw] md:text-[9vw] lg:text-[9rem] font-black uppercase tracking-tighter leading-[0.8] text-white mix-blend-plus-lighter drop-shadow-2xl">
                            {PAGE_DATA.title}
                        </h1>
                        ...
                        >
                            <div className="flex justify-between items-center border-b border-white/10 pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-white">Retail Deployment</span>
                                </div>
                                <Globe size={16} className="text-white/50" />
                            </div>
                            
                            <p className="text-[11px] text-white/80 leading-relaxed font-light">
                                Dominating premium retail spaces across the Kingdom. We transform heavy footfall into measurable brand engagement.
                            </p>
                ...
                <div className="max-w-[1800px] mx-auto">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="flex flex-col md:flex-row md:items-end justify-between border-b border-white/10 pb-12 mb-12 md:mb-16 gap-6">
                        <div>
                            ...
                            <h2 className="text-4xl md:text-6xl font-medium tracking-tighter text-white drop-shadow-md">Retail Infrastructure</h2>
                        </div>
                        <p className="text-xs font-mono text-white/50 uppercase tracking-widest max-w-xs md:text-right">
                            Engineered for high-traffic environments and rapid deployment.
                        </p>
                    </motion.div>
                ...
                <div className="max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
                    ...
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="lg:col-span-5 sticky top-32 self-start">
                        ...
                        <p className="text-white/70 font-light text-lg">
                            We navigate complex mall regulations effortlessly. Our process guarantees rapid overnight deployment without disrupting public operations.
                        </p>
                    </motion.div>
            ...
            <section className="py-24 md:py-40 px-4 md:px-12 lg:px-24 shrink-0">
                <div className="max-w-[1800px] mx-auto">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="flex flex-col items-center text-center mb-16 md:mb-24">
                        ...
                        <h2 className="text-4xl md:text-7xl font-medium tracking-tighter text-white drop-shadow-md">Retail Archive</h2>
                        <span className="text-[10px] font-mono text-white/50 mt-6 tracking-[0.3em] uppercase">Select Deployments // GCC Malls</span>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 auto-rows-[250px] md:auto-rows-[350px] gap-3 md:gap-5">
                        {PAGE_DATA.images.map((src, i) => {
                            ...
                            return (
                                ...
                                >
                                    <Image 
                                        src={src} alt={`Kiosk ${i+1}`} fill sizes="(max-width: 768px) 100vw, 50vw"
                                    ...
                                    <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8">
                                        <div className="translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out flex items-end justify-between">
                                            <div className="flex flex-col gap-1">
                                                <span className="text-[9px] font-bold uppercase tracking-widest text-white">Retail Case Study</span>
