...
const TEXT_AR = {
    ...
    langToggle: "EN",
    title: "الفعاليات",
    subtitle: "نصنع تجارب تترك صدى.",
    globalReach: "وصول عالمي. خبرة إقليمية.",
    ...
    philosophy: "منظورنا",
    overview: "نؤمن بأن كل فعالية أكثر من مجرد تجمع — إنها لحظة تأثير، ومنصة للتواصل، وفرصة لخلق أثر دائم. من خلال التفكير الاستراتيجي والابتكار الإبداعي والتنفيذ المتقن، نحوّل المساحات إلى قصص والجماهير إلى مشاركين.",

    perspectiveTitle: "نصمم اللحظات الفارقة.",
    perspectiveText: "الفعاليات الخالدة في الذاكرة لا تُقاس بعدد الحضور فحسب، بل بالمشاعر التي تثيرها، والحوارات التي تلهمها، والانطباعات التي تتركها. في كلرز، نتصور ونصمم وننفذ تجارب عالية التأثير تشرك الجماهير على مستوى أعمق. من قمم القيادة والمراسم الحكومية إلى المهرجانات العامة وإطلاق المنتجات والاحتفالات واسعة النطاق، ننسق كل التفاصيل بهدف ودقة.",
    perspectiveNote: "نتعامل مع كل مشروع كسرد فريد — مصمم بعناية ليعكس رؤيتك، ويعزز علامتك التجارية، ويخلق روابط إنسانية هادفة.",

    coreCompetencies: "تصميم وتنفيذ الفعاليات",
    eventArch: "من الرؤية إلى الواقع.",
    eventArchDesc: "بالجمع بين التوجيه الإبداعي والخبرة التقنية والتميز التشغيلي، نقدم فعاليات جذابة وفعّالة استراتيجيًا.",

    cap1Title: "مؤتمرات الشركات وقمم القيادة", cap1Desc: "بيئات مصممة بهادفية، تعزز الحوار، وتلهم التعاون، وترتقي بالحضور من خلال تنفيذ سلس وتصميم مدروس.",
    ...
    cap3Title: "التجارب التفاعلية للعلامات التجارية والتسويق التجريبي", cap3Desc: "تجارب ديناميكية تحوّل رسائل العلامة التجارية إلى تفاعلات لا تُنسى، وتبني روابط أصيلة بين العلامات والجماهير.",
    ...
    methodDesc: "التجارب الاستثنائية لا تحدث مصادفةً، بل تصمم بدقة متناهية. تجمع منهجيتنا بين التخطيط الاستراتيجي والابتكار الإبداعي والانضباط التشغيلي.",

    step1Vol: "01", step1Title: "الاستراتيجية وتصميم التجربة", step1Desc: "نبدأ بفهم الأهداف والجماهير والأماكن والواقع التشغيلي. من خلال هذه العملية، نطور إطار تجربة متماسكًا يوائم الرؤية مع التنفيذ.",
    ...
    step3Vol: "03", step3Title: "الإنتاج المباشر وإدارة الفعالية", step3Desc: "تشرف فرقنا على كل جانب من جوانب التنفيذ، وتوجه العمليات في الوقت الفعلي، وتضمن تنسيقًا مُحكم التنفيذ من اللحظة الافتتاحية إلى التصفيق الأخير.",

    archiveTitle: "محفظة من التجارب",
    selectDeps: "أعمال مختارة",
    archiveDesc: "يمثل كل مشروع تحديًا فريدًا، ورؤية مميزة، والتزامًا بتحويل الأفكار إلى وقائع وأحداث لا تُنسى.",
    caseStudy: "دراسة حالة لفعالية",
    archiveIndex: "أرشيف_0",

    ctaTitle: "مستعد لصنع شيء استثنائي؟",
    ctaDesc: "سواء كنت تطلق علامة تجارية، أو تستضيف مؤتمرًا عالميًا، أو تقيم احتفالًا بارزًا، أو تبتكر تجربة عامة غامرة، فإن فريقنا مستعد لتحويل رؤيتك إلى واقع. لنبنِ تجربة يتذكرها الناس طويلًا بعد أن تنطفئ الأضواء.",
