...
const TEXT_EN = {
    ...
    langToggle: "عربي",
    title: "EVENTS",
    subtitle: "Agency Division // Signature Experiences",
    globalReach: "Global Reach",
    heroDesc: "Curating immersive spatial experiences across the GCC. We bridge the gap between creative ambition and flawless physical execution.",
    ...
    stat1Label: "Footfall Curated", stat1Value: "150k+",
    stat2Label: "Execution Standard", stat2Value: "Flawless",
    stat3Label: "Client Satisfaction", stat3Value: "100%",
    
    coreCompetencies: "Core Competencies",
    eventArch: "Event Architecture",
    eventArchDesc: "Comprehensive solutions for brand activations and corporate summits.",
    
    cap1Title: "Corporate Summits", cap1Desc: "Professional environments for conferences, networking, and major company announcements.",
    cap2Title: "Live Concerts", cap2Desc: "Massive stage builds, high-fidelity audio, and crowd management for thousands.",
    cap3Title: "Brand Pop-ups", cap3Desc: "Engaging, physical spaces designed to connect your brand directly with consumers.",
    cap4Title: "VIP Experiences", cap4Desc: "Highly exclusive, beautifully designed settings for private galas and royal protocol.",

    methodology: "Methodology",
    artOfExec: "The Art of Execution.",
    methodDesc: "We do not leave experiences to chance. Our structured methodology ensures perfect delivery from ideation to the final curtain drop.",
    
    step1Vol: "Vol. 01", step1Title: "Creative Blueprint", step1Desc: "Mapping venue constraints, crowd flow, and establishing the core aesthetic narrative.",
    step2Vol: "Vol. 02", step2Title: "Spatial Rehearsal", step2Desc: "Full AV, lighting, and stage mechanics simulation prior to physical deployment.",
    step3Vol: "Vol. 03", step3Title: "Live Orchestration", step3Desc: "Real-time show calling, directing, and on-the-ground operational management.",

    archiveTitle: "Curated Archive",
    selectDeps: "Select Deployments // 2024",
    caseStudy: "Event Case Study",
    archiveIndex: "Archive_0",

    ctaTitle: "Ready to elevate your narrative?",
...
const TEXT_AR = {
    ...
    langToggle: "EN",
    title: "الفعاليات",
    subtitle: "قسم الوكالة // تجارب مميزة",
    globalReach: "وصول عالمي",
    heroDesc: "تنسيق تجارب مكانية غامرة في جميع أنحاء دول مجلس التعاون الخليجي. نحن نسد الفجوة بين الطموح الإبداعي والتنفيذ المادي الخالي من العيوب.",
    philosophy: "فلسفتنا",
    ...
    stat1Label: "إقبال تم تنظيمه", stat1Value: "+150 ألف",
    stat2Label: "معيار التنفيذ", stat2Value: "بلا عيوب",
    stat3Label: "رضا العملاء", stat3Value: "100%",
    
    coreCompetencies: "الكفاءات الأساسية",
    eventArch: "هندسة الفعاليات",
    eventArchDesc: "حلول شاملة لتنشيط العلامات التجارية والمؤتمرات المؤسسية.",
    
    cap1Title: "المؤتمرات المؤسسية", cap1Desc: "بيئات احترافية للمؤتمرات، والتواصل، وإعلانات الشركات الكبرى.",
    cap2Title: "الحفلات الحية", cap2Desc: "بناء مسارح ضخمة، صوت عالي الدقة، وإدارة حشود للآلاف.",
    cap3Title: "متاجر مؤقتة للعلامات", cap3Desc: "مساحات مادية جذابة مصممة لربط علامتك التجارية مباشرة بالمستهلكين.",
    cap4Title: "تجارب كبار الشخصيات", cap4Desc: "إعدادات حصرية للغاية ومصممة بشكل جميل للحفلات الخاصة والبروتوكول الملكي.",

    methodology: "المنهجية",
    artOfExec: "فن التنفيذ.",
    methodDesc: "نحن لا نترك التجارب للصدفة. تضمن منهجيتنا المنظمة تسليماً مثالياً من الفكرة إلى إسدال الستار النهائي.",
    
    step1Vol: "مجلد. 01", step1Title: "المخطط الإبداعي", step1Desc: "تخطيط قيود المكان، وتدفق الحشود، وإنشاء السرد الجمالي الأساسي.",
    step2Vol: "مجلد. 02", step2Title: "البروفة المكانية", step2Desc: "محاكاة كاملة للصوت والصورة والإضاءة وميكانيكا المسرح قبل النشر المادي.",
    step3Vol: "مجلد. 03", step3Title: "التنسيق المباشر", step3Desc: "إدارة العرض في الوقت الفعلي، والتوجيه، والإدارة التشغيلية على أرض الواقع.",

    archiveTitle: "أرشيف منسق",
    selectDeps: "تطبيقات مختارة // 2024",
    caseStudy: "دراسة حالة لفعالية",
    archiveIndex: "أرشيف_0",

    ctaTitle: "هل أنت مستعد للارتقاء بقصتك؟",
...
export default function EventsPage() {
    ...
    return (
        ...
        <main ref={containerRef} className={`bg-[#050505] h-screen w-full text-white font-sans selection:bg-rose-500/30 overflow-y-auto overflow-x-hidden relative scroll-smooth custom-scrollbar ${isAr ? 'dir-rtl' : 'dir-ltr'}`} dir={isAr ? "rtl" : "ltr"}>
